  ...
  return (
    ...
    >
      ...
      <div style={filtersContainerStyles}>
        <button
          style={currentFilter === 'all' ? activeFilterStyles : filterButtonStyles}
        ...
        <button
          style={currentFilter === 'active' ? activeFilterStyles : filterButtonStyles}
        ...
        <button
          style={currentFilter === 'completed' ? activeFilterStyles : filterButtonStyles}
